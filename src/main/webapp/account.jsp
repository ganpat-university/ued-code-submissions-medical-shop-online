  ...
  <div class="col-sm-6 col-md-5">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">See your account's personal information.</p>
  ...
  <div class="col-sm-6 col-md-5">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">You Can Check Your cart.</p>
        <a href="cart.jsp" class="btn btn-danger">Your Cart</a>
      </div>
    </div>
  </div>
</div><br><br>
  ...
  <div class="col-sm-6 col-md-5">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">You can change your account's password from here.</p>
