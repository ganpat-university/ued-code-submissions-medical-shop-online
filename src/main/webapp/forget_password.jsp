            ...
            <div class="card-body p-5">
              ...
              <form action="forget_password_logic.jsp" method="post">
                ...
                <div class="d-flex justify-content-center">
                  <button type="submit" class="btn btn-primary btn-block btn-lg gradient-custom-4 text-body" style="color:#fff !important;background:#3bb896 !important;">Submit</button>
                </div>
