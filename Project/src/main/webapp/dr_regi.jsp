   ...
   <div class="col-sm-3">
    <div class="card">
      <div class="card-body">
        ...
        <a href="dr_appointment_2.jsp" class="btn btn-primary c">Go somewhere</a>
      </div>
    </div>
  </div>
   <div class="col-sm-3">
    <div class="card">
      <div class="card-body">
        ...
        <a href="dr_appointment_3.jsp" class="btn btn-primary c">Go somewhere</a>
      </div>
    </div>
  </div>
  <div class="col-sm-3">
    <div class="card">
      <div class="card-body">
        ...
        <a href="dr_appointment_4.jsp" class="btn btn-primary c">Go somewhere</a>
      </div>
    </div>
  </div>
</div></div>
